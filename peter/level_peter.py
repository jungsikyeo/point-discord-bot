    ...
    try:
        with connection.cursor() as cursor:
            ...
            if last_message:
                ...
                cursor.execute("""
                    INSERT INTO user_levels_neowiz (user_id, guild_id, xp, last_message_time)
                    VALUES (%s, %s, %s, %s)
                """, (user_id, guild_id, points, current_time))
                connection.commit()

            cursor.execute("""
                INSERT INTO user_message_logs_neowiz (user_id, guild_id, xp, message_hash, message_time)
                VALUES (%s, %s, %s, %s, %s)
